...
def upsert_device(db: Session, data: dict) -> Device:
    ...
    sos_signal, movement, rssi, battery). AI score fields
    (severity_score, priority_class, is_anomaly) are left at their
    defaults on ingest — the AI pipeline updates them separately.
